...
export const categories: Category[] = [
  {
    ...
    description:
      "Вертикальные (РВС) и горизонтальные (РГСП, РГСН, РГД) резервуары, баки-аккумуляторы горячей воды (БАГВ) и подземные дренажные ёмкости (ЕП) объёмом от 2 до 20 000 м³.",
    icon: "tank-vertical",
  },
  {
    id: "emkostnye",
