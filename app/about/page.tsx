...
export const metadata: Metadata = {
  title: "О заводе",
  description:
    "Московский Завод Резервуарного Оборудования (МОСРЕЗЕРВУАР) — изготовление и монтаж всех типов резервуаров, баков и ёмкостей, дымовых труб и металлоконструкций. Разрешительная документация, ISO 9001, работа с госкомпаниями.",
};
  ...
  return (
    <>
      <PageHeader
        ...
        description="Изготовление и монтаж всех типов резервуаров, баков и ёмкостей, дымовых труб и металлоконструкций для промышленных предприятий и государственных заказчиков."
      />
      ...
      <section className="bg-white">
        <div className="mx-auto max-w-3xl px-4 py-16 md:px-8 lg:py-24">
          <p className="text-base leading-relaxed text-graphite">
            ...
            лидирующие позиции на российском рынке. Мы работаем как с государственными компаниями,
